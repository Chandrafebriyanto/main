...
class Snake(GameObject):
    ...
    def change_direction(self, direction):
        # Update desired direction first; actual direction is applied in move()
...
class Game:
    ...
    def game_over(self):
        ...
        game_over_surface = my_font.render('You Lost!', True, pygame.Color(255, 0, 0))
