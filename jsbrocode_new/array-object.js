const fruit = [
  { name: "apple", color: "red", size: "big" },
  { name: "grape", color: "purple", size: "small" },
  { name: "banana", color: "yellow", size: "big" },
  { name: "kiwi", color: "green", size: "small" },
];

fruit.push({ name: "orange", color: "orange", size: "big" });

console.log(fruit);
// console.log(fruit[0].name); // apple
// console.log(fruit[0].color); // purple
